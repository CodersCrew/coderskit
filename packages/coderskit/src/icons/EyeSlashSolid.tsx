...
const SvgEyeSlashSolid = (props: SVGProps<SVGSVGElement>) => (
  <svg
    aria-hidden="true"
    data-prefix="fas"
    data-icon="eye-slash"
    className="eye-slash-solid_svg__svg-inline--fa eye-slash-solid_svg__fa-eye-slash eye-slash-solid_svg__fa-w-20"
    viewBox="0 0 640 512"
    {...props}
  >
    <path
